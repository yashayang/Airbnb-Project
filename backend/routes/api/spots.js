...
const validateSpot = [
  ...
  check('page').notEmpty().withMessage('Page must be greater than or equal to 0'),
  check('size').notEmpty().withMessage('Size must be greater than or equal to 0'),
  check('maxLat').notEmpty().isLength({max: 10}).withMessage('Maximum latitude is invalid'),
  check('minLat').notEmpty().isLength({min: 2}).withMessage('Minimum latitude is invalid'),
  check('maxLng').notEmpty().isLength({max: 11}).withMessage('Maximum longitude is invalid'),
  check('minLng').notEmpty().isLength({min: 3}).withMessage('Minimum longitude is invalid'),
  check('maxPrice').notEmpty().withMessage('Maximum price must be greater than or equal to 0'),
  check('minPrice').notEmpty().withMessage('Minimum price must be greater than or equal to 0'),
